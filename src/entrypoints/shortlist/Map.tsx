...
import { DEFAULT_SHOWING, groupOf, type Group } from '@/lib/shortlist';
import type { ShortlistEntry } from '@/lib/supabase';

/** Every place on one map, coloured by what the two of you said.
 *
 *  Leaflet is bundled rather than loaded from a CDN because MV3 forbids remote script outright.
