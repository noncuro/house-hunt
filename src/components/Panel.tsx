...
import { CappedNotice, SpendWarning } from './Spend';
import { VerdictLine, RatingButtons } from './Verdict';
...
import { HubFact } from './Hub';
import { hubsFromProject, type Hub } from '@/lib/hubs';
import { formatDuration, MapsButton, MODE_ICON, readTravel, Routes, TransitBasis } from './Journey';
import { Stations, STATIONS_SHOWN } from './Stations';
...
import './panel.css';
import { SizeFact, sqft } from './Size';
import type { Point } from '@/lib/postcode';
import {
  TRAVEL_MODES,
  type Analysis,
  type Listing,
  ...
  return (
    ...
    >
      ...
      <Section title="Travel times" note={<TransitBasis />}>
        {places.length === 0 ? (
          <div className="rm-empty">Add places in the extension popup</div>
        ) : !listing.postcode ? (
